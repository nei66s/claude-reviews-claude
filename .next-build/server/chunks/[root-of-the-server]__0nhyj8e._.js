module.exports=[18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},23862,e=>e.a(async(t,r)=>{try{let t=await e.y("pg-587764f78a6c7a9c");e.n(t),r()}catch(e){r(e)}},!0),22199,e=>e.a(async(t,r)=>{try{var a=e.i(23862),n=t([a]);[a]=n.then?(await n)():n;let m=process.env.DATABASE_URL?.trim(),p=process.env.PGSSLMODE?.trim()==="require"?{rejectUnauthorized:!1}:void 0;function i(e){let t=Number(e);return!Number.isFinite(t)||t<=0?null:Math.floor(t)}function s(e){return"object"==typeof e&&null!==e&&"code"in e}function o(e){return!!s(e)&&("53300"===e.code||"57P03"===e.code)}function l(){if(!m)throw Error("DATABASE_URL is not configured.");if(!e.g.__chocksPgPoolShutdownHandlersRegistered){e.g.__chocksPgPoolShutdownHandlersRegistered=!0;let t=async()=>{let t=e.g.__chocksPgPool;e.g.__chocksPgPool=void 0,t&&await t.end().catch(()=>null)};process.on("beforeExit",()=>{t()}),process.on("SIGINT",()=>{t().finally(()=>process.exit(0))}),process.on("SIGTERM",()=>{t().finally(()=>process.exit(0))})}if(!e.g.__chocksPgPool){let t=i(process.env.PG_POOL_MAX)??10,r=i(process.env.PG_POOL_IDLE_TIMEOUT_MS)??3e4,n=i(process.env.PG_POOL_CONNECTION_TIMEOUT_MS)??5e3;e.g.__chocksPgPool=new a.Pool({connectionString:m,ssl:p,max:t,idleTimeoutMillis:r,connectionTimeoutMillis:n}),e.g.__chocksPgPool.on("error",e=>{console.error("[db] Pool error:",e)})}return e.g.__chocksPgPool}async function u(e,t=[]){let r=i(process.env.PG_QUERY_RETRIES)??0,a=i(process.env.PG_QUERY_RETRY_BASE_DELAY_MS)??100,n=i(process.env.PG_QUERY_RETRY_MAX_DELAY_MS)??2e3;for(let i=0;i<=r;i++)try{let r=l();return await r.query(e,t)}catch(u){if(!(i<r&&o(u)))throw u;let e=Math.min(n,a*2**i),t=Math.floor(50*Math.random()),l=e+t;console.warn(`[db] Postgres busy (${s(u)?u.code:"unknown"}). Retrying query in ${l}ms (${i+1}/${r+1})...`),await function(e){return new Promise(t=>setTimeout(t,e))}(l)}throw Error("dbQuery: exhausted retries")}async function c(e){return(await u(`select id, email, display_name
    ...
    limit 1
    `,[e,t]);return i.rows[0]?p(i.rows[0]):null}async function b(e,t,r,a){await o(a);let s=a??(0,n.getDb)(),l=m(r,i.MEMORY_ITEM_STATUSES,"candidate"),u=await s.query(`
    update public.user_memory_items
    set status = $3,
        updated_at = now()
    where user_id = $1 and id = $2
    returning *
    `,[e,t,l]);return u.rows[0]?p(u.rows[0]):null}async function E(e,t,r,a){await o(a);let i=a??(0,n.getDb)(),s="string"==typeof r.category?r.category:void 0,l="string"==typeof r.content?r.content:void 0,u="string"==typeof r.normalizedValue?r.normalizedValue:void 0,c=await i.query(`
    update public.user_memory_items
    ...
    where user_id = $1
    limit 1
    `,[e]);return a.rows[0]?_(a.rows[0]):null}async function x(e,t){await o(t);let r=t??(0,n.getDb)(),a=e.interactionPreferences??{},i=e.recurringTopics??[],s=e.activeGoals??[],l=e.knownConstraints??[],u=e.keyFacts??[],c=await r.query(`
    ...
    on conflict (user_id) do update set
      ...
      updated_at = now()
    returning *
    `,[e.userId,e.summaryShort??"",e.summaryLong??"",JSON.stringify(a),JSON.stringify(i),JSON.stringify(s),JSON.stringify(l),JSON.stringify(u),e.profileVersion??1,e.lastCompiledAt??null]);return _(c.rows[0])}async function R(e,t){await o(t);let r=t??(0,n.getDb)(),a=m(e.action,i.MEMORY_AUDIT_ACTIONS,"created"),s=e.previousStatus??null,l=e.newStatus??null,u=await r.query(`
    ...
    returning *
    `,[e.memoryItemId,e.userId,a,s,l,e.reason??"",e.actor??"system"]);return y(u.rows[0])}function I(e){let t,r,a=y(e),n=e.item_content_preview,i=null==n?null:String(n).trim().slice(0,140)||null;return{...a,itemType:(t=e.item_type)?String(t):null,itemStatus:(r=e.item_status)?String(r):null,itemContentPreview:i}}async function A(e,t){await o(t);let r=t??(0,n.getDb)(),a=(await r.query(`
    select
    ...
    limit $3
    `,[e,s,i])).rows.map(I)}async function T(e){await o();let t=(0,n.getDb)(),r=await t.connect();try{await r.query("BEGIN");let t=await e(r);return await r.query("COMMIT"),t}catch(e){throw await r.query("ROLLBACK").catch(()=>null),e}finally{r.release()}}e.s(["findActiveUserMemoryItemByDedupeKey",0,w,"findActiveUserMemoryItemsByNormalizedValue",0,h,"getMemoryAuditSummary",0,A,"getUserMemoryItemById",0,v,"getUserProfile",0,S,"insertMemoryAuditLogEntry",0,R,"insertUserMemoryItem",0,f,"listMemoryAuditEvents",0,M,"listUserMemoryItemsByUserId",0,g,"updateUserMemoryItemFields",0,E,"updateUserMemoryItemStatus",0,b,"upsertUserProfile",0,x,"withMemoryTransaction",0,T]),r()}catch(e){r(e)}},!1),54499,e=>e.a(async(t,r)=>{try{var a=e.i(64698),n=t([a]);[a]=n.then?(await n)():n;let s=["declared_fact","constraint","goal","preference","interaction_style"];async function i(e){let t=Number.isFinite(e.limitItems)?Math.max(1,Math.min(30,e.limitItems)):12,r=e.includeTypes?.length?e.includeTypes:s,[n,i]=await Promise.all([(0,a.getUserProfile)(e.userId),(0,a.listUserMemoryItemsByUserId)(e.userId,{status:"active",limit:200})]),o=i.filter(e=>r.includes(e.type)).slice(0,t);return{userId:e.userId,summaryShort:n?.summaryShort??"",keyFacts:n?.keyFacts??[],activeGoals:n?.activeGoals??[],interactionPreferences:n?.interactionPreferences??{},knownConstraints:n?.knownConstraints??[],memoryItems:o.map(e=>({id:e.id,type:e.type,category:e.category,content:e.content,normalizedValue:e.normalizedValue,sensitivityLevel:e.sensitivityLevel}))}}e.s(["buildContextPack",0,i]),r()}catch(e){r(e)}},!1),80264,e=>e.a(async(t,r)=>{try{var a=e.i(89171),n=e.i(54499),i=e.i(39061),s=e.i(97914),o=e.i(22199),l=t([n,s,o]);async function u(e){let t=(0,s.requireUser)(e);if(!t)return a.NextResponse.json({error:"Não autorizado."},{status:401});let r=await e.json().catch(()=>null),l="string"==typeof r?.userId?r.userId.trim():"";if(!l)return a.NextResponse.json({error:"userId required"},{status:400});if("local-admin"!==t.id&&t.id!==l)return a.NextResponse.json({error:"Proibido."},{status:403});let u=function(e){if(!Array.isArray(e))return;let t=new Set(i.MEMORY_ITEM_TYPES),r=e.map(e=>String(e||"").trim()).filter(e=>t.has(e));return r.length?r:void 0}(r?.includeTypes),c=function(e){let t=Number(e);if(Number.isFinite(t))return Math.max(1,Math.min(30,Math.floor(t)))}(r?.limitItems);try{let e=await (0,n.buildContextPack)({userId:l,agentType:"string"==typeof r?.agentType?r.agentType:void 0,taskType:"string"==typeof r?.taskType?r.taskType:void 0,limitItems:c,includeTypes:u});return a.NextResponse.json({contextPack:e})}catch(e){if((0,o.isDatabaseBusyError)(e))return a.NextResponse.json({error:"Banco de dados ocupado (muitos clientes). Tente novamente em alguns segundos."},{status:503});return a.NextResponse.json({error:e instanceof Error?e.message:"Falha ao gerar contexto."},{status:500})}}[n,s,o]=l.then?(await l)():l,e.s(["POST",0,u]),r()}catch(e){r(e)}},!1),67279,e=>e.a(async(t,r)=>{try{var a=e.i(47909),n=e.i(74017),i=e.i(96250),s=e.i(59756),o=e.i(61916),l=e.i(74677),u=e.i(69741),c=e.i(16795),d=e.i(87718),m=e.i(95169),p=e.i(47587),_=e.i(66012),y=e.i(70101),f=e.i(74838),g=e.i(10372),h=e.i(93695);e.i(52474);var w=e.i(220),v=e.i(80264),b=t([v]);[v]=b.then?(await b)():b;let S=new a.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/memory/context/build/route",pathname:"/api/memory/context/build",filename:"route",bundlePath:""},distDir:".next-build",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/memory/context/build/route.ts",nextConfigOutput:"",userland:v,...{}}),{workAsyncStorage:x,workUnitAsyncStorage:R,serverHooks:I}=S;async function E(e,t,r){r.requestMeta&&(0,s.setRequestMeta)(e,r.requestMeta),S.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let a="/api/memory/context/build/route";a=a.replace(/\/index$/,"")||"/";let i=await S.prepare(e,t,{srcPage:a,multiZoneDraftMode:!1});if(!i)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:v,params:b,nextConfig:E,parsedUrl:x,isDraftMode:R,prerenderManifest:I,routerServerContext:A,isOnDemandRevalidate:M,revalidateOnlyGenerated:T,resolvedPathname:$,clientReferenceManifest:P,serverActionsManifest:N}=i,C=(0,u.normalizeAppPath)(a),k=!!(I.dynamicRoutes[C]||I.routes[$]),O=async()=>((null==A?void 0:A.render404)?await A.render404(e,t,x,!1):t.end("This page could not be found"),null);if(k&&!R){let e=!!I.routes[$],t=I.dynamicRoutes[C];if(t&&!1===t.fallback&&!e){if(E.adapterPath)return await O();throw new h.NoFallbackError}}let D=null;!k||S.isDev||R||(D=$,D="/index"===D?"/":D);let U=!0===S.isDev||!k,q=k&&!U;N&&P&&(0,l.setManifestsSingleton)({page:a,clientReferenceManifest:P,serverActionsManifest:N});let j=e.method||"GET",L=(0,o.getTracer)(),B=L.getActiveScopeSpan(),H=!!(null==A?void 0:A.isWrappedByNextServer),Y=!!(0,s.getRequestMeta)(e,"minimalMode"),F=(0,s.getRequestMeta)(e,"incrementalCache")||await S.getIncrementalCache(e,E,I,Y);null==F||F.resetRequestCache(),globalThis.__incrementalCache=F;let z={params:b,previewProps:I.preview,renderOpts:{experimental:{authInterrupts:!!E.experimental.authInterrupts},cacheComponents:!!E.cacheComponents,supportsDynamicResponse:U,incrementalCache:F,cacheLifeProfiles:E.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>S.onRequestError(e,t,a,n,A)},sharedContext:{buildId:v}},G=new c.NodeNextRequest(e),V=new c.NodeNextResponse(t),K=d.NextRequestAdapter.fromNodeNextRequest(G,(0,d.signalFromNodeResponse)(t));try{let i,s=async e=>S.handle(K,z).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=L.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${j} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t),i&&i!==e&&(i.setAttribute("http.route",n),i.updateName(t))}else e.updateName(`${j} ${a}`)}),l=async i=>{var o,l;let u=async({previousCacheEntry:n})=>{try{if(!Y&&M&&T&&!n)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let a=await s(i);e.fetchMetrics=z.renderOpts.fetchMetrics;let o=z.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let l=z.renderOpts.collectedTags;if(!k)return await (0,_.sendResponse)(G,V,a,z.renderOpts.pendingWaitUntil),null;{let e=await a.blob(),t=(0,y.toNodeOutgoingHttpHeaders)(a.headers);l&&(t[g.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==z.renderOpts.collectedRevalidate&&!(z.renderOpts.collectedRevalidate>=g.INFINITE_CACHE)&&z.renderOpts.collectedRevalidate,n=void 0===z.renderOpts.collectedExpire||z.renderOpts.collectedExpire>=g.INFINITE_CACHE?void 0:z.renderOpts.collectedExpire;return{value:{kind:w.CachedRouteKind.APP_ROUTE,status:a.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==n?void 0:n.isStale)&&await S.onRequestError(e,t,{routerKind:"App Router",routePath:a,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:M})},!1,A),t}},c=await S.handleResponse({req:e,nextConfig:E,cacheKey:D,routeKind:n.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:I,isRoutePPREnabled:!1,isOnDemandRevalidate:M,revalidateOnlyGenerated:T,responseGenerator:u,waitUntil:r.waitUntil,isMinimalMode:Y});if(!k)return null;if((null==c||null==(o=c.value)?void 0:o.kind)!==w.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});Y||t.setHeader("x-nextjs-cache",M?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),R&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let d=(0,y.fromNodeOutgoingHttpHeaders)(c.value.headers);return Y&&k||d.delete(g.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||d.get("Cache-Control")||d.set("Cache-Control",(0,f.getCacheControlHeader)(c.cacheControl)),await (0,_.sendResponse)(G,V,new Response(c.value.body,{headers:d,status:c.value.status||200})),null};H&&B?await l(B):(i=L.getActiveScopeSpan(),await L.withPropagatedContext(e.headers,()=>L.trace(m.BaseServerSpan.handleRequest,{spanName:`${j} ${a}`,kind:o.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},l),void 0,!H))}catch(t){if(t instanceof h.NoFallbackError||await S.onRequestError(e,t,{routerKind:"App Router",routePath:C,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:M})},!1,A),k)throw t;return await (0,_.sendResponse)(G,V,new Response(null,{status:500})),null}}e.s(["handler",0,E,"patchFetch",0,function(){return(0,i.patchFetch)({workAsyncStorage:x,workUnitAsyncStorage:R})},"routeModule",0,S,"serverHooks",0,I,"workAsyncStorage",0,x,"workUnitAsyncStorage",0,R]),r()}catch(e){r(e)}},!1)];

//# sourceMappingURL=%5Broot-of-the-server%5D__0nhyj8e._.js.map