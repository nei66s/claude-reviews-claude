...
export async function createFamilyWorkflow(input) {
    ...
    const workflowId = await startCoordinationWorkflow(team.id, conversationId, input.goal, 'chocks' // Chocks initiates
    );
 ...
 */
export async function createWorkflowFromTemplate(templateKey) {
