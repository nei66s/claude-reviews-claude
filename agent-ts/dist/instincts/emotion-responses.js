 ...
 */
export function calculateResponseTone(emotions) {
 ...
 */
export function buildEmotionalPromptModifier(emotions) {
    const e = emotions || emotionalStateManager.getVector();
 ...
 */
export function calculateDetailLevel(emotions) {
    const e = emotions || emotionalStateManager.getVector();
    const tone = calculateResponseTone(e);
    const details = {
 ...
 */
export function shouldIncludeDisclaimers(emotions) {
    const e = emotions || emotionalStateManager.getVector();
    const tone = calculateResponseTone(e);
 ...
 */
export function shouldVerifyUnderstanding(emotions) {
    const e = emotions || emotionalStateManager.getVector();
 ...
 */
export function buildEmotionalHealthSummary(emotions) {
    const e = emotions || emotionalStateManager.getVector();
 ...
 */
export function transformResponseForEmotion(baseResponse, emotions) {
    const e = emotions || emotionalStateManager.getVector();
    const tone = calculateResponseTone(e);
