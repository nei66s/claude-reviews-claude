...
import { emotionalStateManager } from './emotions'
 ...
 */
export function processEmotionEvent(event: EmotionEvent): void {
 ...
 */
export function processEmotionEvents(events: EmotionEvent[]): void {
 ...
 */
export function decayEmotionsPassively(): void {
