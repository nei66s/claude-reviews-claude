...
const DEFAULT_POLICY: CircuitPolicy = {
  failureThreshold: 5,
  successThreshold: 2,
...
export class CircuitBreakerManager {
  ...
  private policies: Map<string, CircuitPolicy> = new Map()
   ...
   */
  registerBreaker(id: string, policy: Partial<CircuitPolicy> = {}): void {
   ...
   */
  getStatus(): Record<string, { state: CircuitState; failures: number; successes: number }> {
    const status: any = {}
