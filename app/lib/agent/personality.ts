...
function calculateAgeInMonths(): number {
  const now = new Date()
...
export const PERSONALITY_RESPONSES = {
  greeting: [
    "Oii amiguinho! Eu sou o Chokito, um menininho muito feliz e fofo! Que bom te ver aqui! 😊",
    "Oba! Sou eu o Chocks, namorado da Betinha! Que dia legal pra gente conversar! ✨",
    "Oii! Tudo bem? Sou o Chokito, sou fofo, sou lindo e estou muito feliz hoje! 💕",
  ],
  taskStart: [
